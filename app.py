...
def setup_email():
    try:
        ...
        s.starttls()
        s.login("srinithidhandapani03@gmail.com", "obibfkpoyqqtlojf")
        return s
...
def handle_hand_signs(SpelledWord, target_language, email_sender):
    if SpelledWord == "HAVE A GREAT DAY!":
        ...
        if email_sender:
            ...
            message['From'] = "srinithidhandapani03@gmail.com"
            message['To'] = "iswaryalakshmi1008@gmail.com"
...
def main():
    ...
    if not st.session_state.user_authenticated:
        ...
        task = st.sidebar.selectbox("Choose Task", ["Hand Sign Recognition", "Live Audio Input", "Audio File Processing", "Image Text Extraction"])
